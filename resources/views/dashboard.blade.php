...
<div class="row">
    <div class="col-md-4 mb-3">
        <div class="card text-bg-primary shadow-sm">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-truck me-1"></i>{{ __('messages.total_deliveries') }}</h5>
    ...
    <div class="col-md-4 mb-3">
        <div class="card text-bg-warning shadow-sm">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-hourglass-split me-1"></i>{{ __('messages.pending') }}</h5>
    ...
    <div class="col-md-4 mb-3">
        <div class="card text-bg-success shadow-sm">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-check-circle me-1"></i>{{ __('messages.delivered') }}</h5>
...
<div class="card shadow-sm mt-2">
    <div class="card-header bg-dark text-white">
        <h5 class="mb-0"><i class="bi bi-clock-history me-2"></i>{{ __('messages.recent_deliveries') }}</h5>
    </div>
