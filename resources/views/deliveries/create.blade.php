...
@section('title', __('messages.new_delivery'))
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-header bg-dark text-white">
                <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>{{ __('messages.delivery_order') }}</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('deliveries.store') }}">
                    ...
                    <h6 class="text-secondary border-bottom pb-2 mb-3">
                        <i class="bi bi-person-up me-1"></i>{{ __('messages.sender_info') }}
                    </h6>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.sender_phone') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-4">
                        <label class="form-label">{{ __('messages.sender_address') }} <span class="text-danger">*</span></label>
                    ...
                    <h6 class="text-secondary border-bottom pb-2 mb-3">
                        <i class="bi bi-person-down me-1"></i>{{ __('messages.receiver_info') }}
                    </h6>
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <label class="form-label">{{ __('messages.name') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.receiver_phone') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-4">
                        <label class="form-label">{{ __('messages.receiver_address') }} <span class="text-danger">*</span></label>
                    ...
                    <h6 class="text-secondary border-bottom pb-2 mb-3">
                        <i class="bi bi-box-seam me-1"></i>{{ __('messages.package_details') }}
                    </h6>
                    <div class="row mb-3">
                        <div class="col-md-4 mb-3 mb-md-0">
                            <label class="form-label">{{ __('messages.package_type') }} <span class="text-danger">*</span></label>
                            <select name="package_type" class="form-select @error('package_type') is-invalid @enderror" required>
                                <option value="">{{ __('messages.select_type') }}</option>
                                <option value="document" {{ old('package_type') === 'document' ? 'selected' : '' }}>{{ __('messages.document') }}</option>
                                <option value="parcel" {{ old('package_type') === 'parcel' ? 'selected' : '' }}>{{ __('messages.parcel') }}</option>
                                <option value="electronics" {{ old('package_type') === 'electronics' ? 'selected' : '' }}>{{ __('messages.electronics') }}</option>
                                <option value="fragile" {{ old('package_type') === 'fragile' ? 'selected' : '' }}>{{ __('messages.fragile') }}</option>
                                <option value="food" {{ old('package_type') === 'food' ? 'selected' : '' }}>{{ __('messages.food') }}</option>
                                <option value="other" {{ old('package_type') === 'other' ? 'selected' : '' }}>{{ __('messages.other') }}</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">{{ __('messages.est_delivery') }}</label>
                    ...
                    <div class="alert alert-info">
                        ...
                        {{ __('messages.fee_info') }}
                    </div>

                    <div class="d-flex justify-content-between">
                        <a href="{{ route('deliveries.index') }}" class="btn btn-outline-secondary">{{ __('messages.cancel') }}</a>
                        <button type="submit" class="btn btn-dark"><i class="bi bi-check-lg me-1"></i>{{ __('messages.create_delivery') }}</button>
                    </div>
                </form>
            </div>
        </div>
